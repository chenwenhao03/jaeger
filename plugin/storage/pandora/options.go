...
func addFlags(flagSet *flag.FlagSet, nsConfig *namespaceConfig) {
	...
	flagSet.String(
		nsConfig.namespace+suffixAK,
		nsConfig.ak,
		"user ak")
	flagSet.String(
		nsConfig.namespace+suffixSK,
		nsConfig.sk,
		"user sk")
...
func initFromViper(cfg *namespaceConfig, v *viper.Viper) {
	...
	cfg.ak = v.GetString(cfg.namespace + suffixAK)
	cfg.sk = v.GetString(cfg.namespace + suffixSK)
}

// GetPrimary returns primary configuration.
func (opt *Options) GetPrimary() *Configuration {
	opt.primary.Servers = opt.primary.servers
